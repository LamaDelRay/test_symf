 ...
 */
class AdvertSkill extends \LamaDelRay\PlatformBundle\Entity\AdvertSkill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'id', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'level', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'advert', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'skill'];
        }
