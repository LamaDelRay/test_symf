...
namespace Proxies\__CG__\LamaDelRay\PlatformBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Advert extends \LamaDelRay\PlatformBundle\Entity\Advert implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'id', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'nbApplications', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'date', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'title', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'author', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'content', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'published', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'applications', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'slug', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'image', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'categories', '' . "\0" . 'LamaDelRay\\PlatformBundle\\Entity\\Advert' . "\0" . 'updatedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function addCategory(\LamaDelRay\PlatformBundle\Entity\Category $category)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCategory(\LamaDelRay\PlatformBundle\Entity\Category $category)
    {
