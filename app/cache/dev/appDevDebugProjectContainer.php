...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'lamadelray_platform.antispam' => 'getLamadelrayPlatform_AntispamService',
            'lamadelray_platform.doctrine.notification' => 'getLamadelrayPlatform_Doctrine_NotificationService',
            ...
            'platform.antispam' => 'getPlatform_AntispamService',
            'platform.beta.html' => 'getPlatform_Beta_HtmlService',
            'platform.beta.listener' => 'getPlatform_Beta_ListenerService',
            'platform.bigbrother.censorship_listener' => 'getPlatform_Bigbrother_CensorshipListenerService',
            'platform.censorship_listener' => 'getPlatform_CensorshipListenerService',
            'platform.censorship_processor' => 'getPlatform_CensorshipProcessorService',
            'platform.json_paramconverter' => 'getPlatform_JsonParamconverterService',
            'platform.validator.antiflood' => 'getPlatform_Validator_AntifloodService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'platform.beta.listener', 1 => 'processBeta'), 2);
        $instance->addListenerService('kernel.controller', array(0 => 'platform.beta.listener', 1 => 'ignoreBeta'), 0);
        $instance->addListenerService('platform.bigbrother.post_message', array(0 => 'platform.censorship_listener', 1 => 'processMessage'), 0);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->setEntityNamespaces(array('LamaDelRayPlatformBundle' => 'LamaDelRay\\PlatformBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'UserBundle' => 'LamaDelRay\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5009d47a4384454f4079db06e76be4a2cc0bd30a66b6e3b352152b5f12ebe9f2');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('LamaDelRay\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('LamaDelRay\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'LamaDelRay\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'lamadelray_platform.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\Antispam\LamaDelRayAntispam A LamaDelRay\PlatformBundle\Antispam\LamaDelRayAntispam instance.
     */
    protected function getLamadelrayPlatform_AntispamService()
    {
        return $this->services['lamadelray_platform.antispam'] = new \LamaDelRay\PlatformBundle\Antispam\LamaDelRayAntispam($this->get('swiftmailer.mailer.default'), 'en', 50);
    }

    /**
     * Gets the 'lamadelray_platform.doctrine.notification' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\DoctrineListener\ApplicationNotification A LamaDelRay\PlatformBundle\DoctrineListener\ApplicationNotification instance.
     */
    protected function getLamadelrayPlatform_Doctrine_NotificationService()
    {
        return $this->services['lamadelray_platform.doctrine.notification'] = new \LamaDelRay\PlatformBundle\DoctrineListener\ApplicationNotification($this->get('swiftmailer.mailer.default'));
    }
    ...
    /**
     * Gets the 'platform.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\Antispam\LamaDelRayAntispam A LamaDelRay\PlatformBundle\Antispam\LamaDelRayAntispam instance.
     */
    protected function getPlatform_AntispamService()
    {
        $this->services['platform.antispam'] = $instance = new \LamaDelRay\PlatformBundle\Antispam\LamaDelRayAntispam($this->get('swiftmailer.mailer.default'), 50);
    ...
    /**
     * Gets the 'platform.beta.html' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\Beta\BetaHTML A LamaDelRay\PlatformBundle\Beta\BetaHTML instance.
     */
    protected function getPlatform_Beta_HtmlService()
    {
        return $this->services['platform.beta.html'] = new \LamaDelRay\PlatformBundle\Beta\BetaHTML();
    }

    /**
     * Gets the 'platform.beta.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\Beta\BetaListener A LamaDelRay\PlatformBundle\Beta\BetaListener instance.
     */
    protected function getPlatform_Beta_ListenerService()
    {
        return $this->services['platform.beta.listener'] = new \LamaDelRay\PlatformBundle\Beta\BetaListener($this->get('platform.beta.html'), '2016-01-20');
    }

    /**
     * Gets the 'platform.bigbrother.censorship_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\Bigbrother\CensorshipListener A LamaDelRay\PlatformBundle\Bigbrother\CensorshipListener instance.
     */
    protected function getPlatform_Bigbrother_CensorshipListenerService()
    {
        return $this->services['platform.bigbrother.censorship_listener'] = new \LamaDelRay\PlatformBundle\Bigbrother\CensorshipListener($this->get('platform.censorship_processor'), array(0 => 1, 1 => 2, 2 => 3));
    }

    /**
     * Gets the 'platform.censorship_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\Bigbrother\CensorshipListener A LamaDelRay\PlatformBundle\Bigbrother\CensorshipListener instance.
     */
    protected function getPlatform_CensorshipListenerService()
    {
        return $this->services['platform.censorship_listener'] = new \LamaDelRay\PlatformBundle\Bigbrother\CensorshipListener($this->get('platform.censorship_processor'), array(0 => 1, 1 => 2, 2 => 3));
    }

    /**
     * Gets the 'platform.censorship_processor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\Bigbrother\CensorshipProcessor A LamaDelRay\PlatformBundle\Bigbrother\CensorshipProcessor instance.
     */
    protected function getPlatform_CensorshipProcessorService()
    {
        return $this->services['platform.censorship_processor'] = new \LamaDelRay\PlatformBundle\Bigbrother\CensorshipProcessor($this->get('swiftmailer.mailer.default'));
    }

    /**
     * Gets the 'platform.json_paramconverter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\ParamConverter\JsonParamConverter A LamaDelRay\PlatformBundle\ParamConverter\JsonParamConverter instance.
     */
    protected function getPlatform_JsonParamconverterService()
    {
        return $this->services['platform.json_paramconverter'] = new \LamaDelRay\PlatformBundle\ParamConverter\JsonParamConverter();
    }

    /**
     * Gets the 'platform.validator.antiflood' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LamaDelRay\PlatformBundle\Validator\AntifloodValidator A LamaDelRay\PlatformBundle\Validator\AntifloodValidator instance.
     */
    protected function getPlatform_Validator_AntifloodService()
    {
        return $this->services['platform.validator.antiflood'] = new \LamaDelRay\PlatformBundle\Validator\AntifloodValidator($this->get('request_stack'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('LamaDelRay\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '505e04e227949a4bb7f5b3af6b0e6dfb7a26e1a0', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        ...
        $n->setOptions(array('login_path' => 'fos_user_security_login', 'target_path_parameter' => '_target_path', 'use_referer' => true, 'always_use_default_target_path' => false, 'default_target_path' => '/'));
    ...
    protected function getSensioFrameworkExtra_Converter_ManagerService()
    {
        ...
        $instance->add($this->get('platform.json_paramconverter'), 0, NULL);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('505e04e227949a4bb7f5b3af6b0e6dfb7a26e1a0');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LamaDelRayPlatformBundle' => 'LamaDelRay\\PlatformBundle\\LamaDelRayPlatformBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'sql4102112',
            'database_user' => 'sql4102112',
            'database_password' => 'GjMYvtpwkb',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '505e04e227949a4bb7f5b3af6b0e6dfb7a26e1a0',
            'locale' => 'en',
            ...
            'kernel.secret' => '505e04e227949a4bb7f5b3af6b0e6dfb7a26e1a0',
            ...
            'fos_user.model.user.class' => 'LamaDelRay\\UserBundle\\Entity\\User',
