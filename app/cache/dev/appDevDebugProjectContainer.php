...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'lamadelray_platform.doctrine.notificqtion' => 'getLamadelrayPlatform_Doctrine_NotificqtionService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'platform.beta.listener', 1 => 'processBeta'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventListener(array(0 => 'postPersist'), $this->get('lamadelray_platform.doctrine.notificqtion'));
    ...
    /**
     * Gets the 'lamadelray_platform.doctrine.notificqtion' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getLamadelrayPlatform_Doctrine_NotificqtionService()
    {
        return $this->services['lamadelray_platform.doctrine.notificqtion'] = new \LamaDelRay\PlatformBundle\DoctrineListener\ApplicationNotification($this->get('swiftmailer.mailer.default'));
    }
    ...
    {
        return $this->services['platform.beta.listener'] = new \LamaDelRay\PlatformBundle\Beta\BetaListener($this->get('platform.beta.html'), '2016-10-20');
    }
